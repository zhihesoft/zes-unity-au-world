...
{
    public static class Au_AssetSet_Wrap 
    {
            ...
            try
            {
            ...
            
                {
...

                    {
                        ...
                        var result = new Au.AssetSet(arg0);

                    

                    
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Au.AssetSet), result);
    ...
    // ==================== methods start ====================
            ...
            try
            {
        ...
        
                {
                    ...
                    
                    {
                        ...
                        argobj1 = argobj1 != null ? argobj1 : StaticTranslate<System.Action<float>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value1, false); System.Action<float> arg1 = (System.Action<float>)argobj1;
                    

                        var result = obj.LoadBundle (arg0, arg1);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_UnloadBundle(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Au.AssetSet;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_UnloadAllBundles(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Au.AssetSet;
            ...
            try
            {
        ...
        
                {
                    ...
                    
                    {
                        ...
                        var result = obj.ObjectExists (arg0);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_LoadObject(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Au.AssetSet;
        ...
        
                {
                    ...
                    
                    {
                        ...
                        var result = obj.LoadObject (arg0, arg1);
