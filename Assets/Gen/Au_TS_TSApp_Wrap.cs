        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(Au.TS.StartupInfo), false, false, v8Value0, ref argobj0, ref argType0))
                    

                    {
                    
                        argobj0 = argobj0 != null ? argobj0 : StaticTranslate<Au.TS.StartupInfo>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false); Au.TS.StartupInfo arg0 = (Au.TS.StartupInfo)argobj0;
