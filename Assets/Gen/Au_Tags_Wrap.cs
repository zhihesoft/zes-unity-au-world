...
{
    public static class Au_Tags_Wrap 
    {
            ...
            try
            {
            ...
            
                {
...

                    {
                        ...
                        var result = new Au.Tags();

                    

                    
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Au.Tags), result);
    ...
    // ==================== methods start ====================
        ...
        private static void M_Get(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Au.Tags;
    ...
    // ==================== properties start ====================
        ...
        private static void S_items(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(info, 0);
                object argobj0 = null;
                argobj0 = argobj0 != null ? argobj0 : StaticTranslate<Au.Tag[]>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false); Au.Tag[] arg0 = (Au.Tag[])argobj0;
                obj.items = arg0;
